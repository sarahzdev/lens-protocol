# Lens Protcol Primer
This is a cloned repo of the [Lens Protocol repo](https://github.com/aave/lens-protocol). Followed this [guide](https://docs.lens.dev/docs/primer) to deploy and interact with the protocol.
